...
export const StbyEngDisp = (props) => {
    ...
    return(
        <g>
            ...
            <text x={814} y={848} fontSize={40} fill={ColorMode} className='FrontPNL' textAnchor="end">{RatingTHR}0</text>
            ...
            <g visibility={DispMode ? 'visible' : 'hidden'} >
                <text x={825} y={873} fontSize={19} fill={ColorMode} className='EngCNTRL' textAnchor="middle">N2</text> 
                ...
                <text x={988} y={945} fontSize={40} fill={ColorMode} className='FrontPNL' textAnchor="end">{EGTEng4}</text>
                <text x={988} y={993} fontSize={40} fill={ColorMode} className='FrontPNL' textAnchor="end">{N1Eng4}</text>

                <text x={825} y={896} fontSize={19} fill={ColorMode} className='EngCNTRL' textAnchor="middle">EPR</text>
                <text x={825} y={944} fontSize={19} fill={ColorMode} className='EngCNTRL' textAnchor="middle">EGT</text>
                <text x={825} y={994} fontSize={19} fill={ColorMode} className='EngCNTRL' textAnchor="middle">N1</text>
            </g>
        </g>
    )
};
