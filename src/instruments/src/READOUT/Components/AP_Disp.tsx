    ...
    return(
      ...
      <text x={642} y={482} fontSize={35} className='OHPNL' textAnchor="end">
        {fuelDisplayMode === 'normal' ? Fuel_4 : '88888'}
            ...
            <text x={64} y={555} fontSize={38} fill={(AFCS_Color) ? '#C6C6C6' : '#00EE00'} className='FrontPNL' textAnchor="end">{AP_API}</text>
            <text x={212} y={555} fontSize={40} fill={(AFCS_Color) ? '#C6C6C6' : '#00EE00'} className='FrontPNL' textAnchor="end">{AP_SPD}{Disp_AT_CMMD}</text>

            <text x={329} y={555} fontSize={40} fill={(AFCS_Color) ? '#C6C6C6' : '#00EE00'} className='FrontPNL' textAnchor="end">{AP_HDG}M</text>

            <text visibility={AP_VertSpd<10000 ? 'visible' : 'hidden'} x={406} y={553} fontSize={30} fill={(AFCS_Color) ? '#C6C6C6' : '#00EE00'} className='FrontPNL' textAnchor="end">{AP_VS_SIGN}</text>

            <text visibility={AP_VertSpd<1000 ? 'visible' : 'hidden'} x={446} y={552} fontSize={27} fill={(AFCS_Color) ? '#C6C6C6' : '#00EE00'} className='FrontPNL' textAnchor="end">-</text>
            <text visibility={AP_VertSpd<1000 ? 'visible' : 'hidden'} x={446} y={563} fontSize={27} fill={(AFCS_Color) ? '#C6C6C6' : '#00EE00'} className='FrontPNL' textAnchor="end">-</text>
            <text visibility={AP_VertSpd<10000 ? 'visible' : 'hidden'} x={426} y={552} fontSize={27} fill={(AFCS_Color) ? '#C6C6C6' : '#00EE00'} className='FrontPNL' textAnchor="end">-</text>
            <text visibility={AP_VertSpd<10000 ? 'visible' : 'hidden'} x={426} y={563} fontSize={27} fill={(AFCS_Color) ? '#C6C6C6' : '#00EE00'} className='FrontPNL' textAnchor="end">-</text>
            <text x={448} y={555} fontSize={40} fill={(AFCS_Color) ? '#C6C6C6' : '#00EE00'} className='FrontPNL' textAnchor="end">{AP_VertSpd < 999 ? '' : AP_VS_THOU}</text>
            <text x={488} y={546} fontSize={27} fill={(AFCS_Color) ? '#C6C6C6' : '#00EE00'} className='FrontPNL' textAnchor="end">{AP_VS_HUND}</text>


            <text x={578} y={555} fontSize={40} fill={(AFCS_Color) ? '#C6C6C6' : '#00EE00'} className='FrontPNL' textAnchor="end">{AP_ALT < 999 ? '' : AP_ALT_THOU}</text>
            <text x={618} y={546} fontSize={27} fill={(AFCS_Color) ? '#C6C6C6' : '#00EE00'} className='FrontPNL' textAnchor="end">{AP_ALT_HUND}</text>
            <text visibility={AP_ALT<10000 ? 'visible' : 'hidden'} x={556} y={552} fontSize={27} fill={(AFCS_Color) ? '#C6C6C6' : '#00EE00'} className='FrontPNL' textAnchor="end">-</text>
            <text visibility={AP_ALT<10000 ? 'visible' : 'hidden'} x={556} y={563} fontSize={27} fill={(AFCS_Color) ? '#C6C6C6' : '#00EE00'} className='FrontPNL' textAnchor="end">-</text>
