(function () {
	...
	*/
	...
	const Airdrop_CAWS = () => {
	  useSimVar('A:GPS POSITION LAT', 'Degrees', 500);
	  useSimVar('A:GPS POSITION LON', 'Degrees', 500);
	  useSimVar('L:C17_AD_Lat', 'Degrees');
	  useSimVar('L:C17_AD_Lon', 'Degrees');
	  useSimVar('L:C17_AD_Dist', 'kilometers');
	  useSimVar('L:C17_AD_ACTIVE', 'bool');
	...
	const AURALS = () => {
	  ...
	  react.useEffect(() => {
	    ...
	    if (!isInitialRenderWacs.current && Avionics_PWR) {
	      ...
	      const timerId = setTimeout(() => {
	        setWacsFail(true);
	      }, delay); // Cleanup the timer if the component unmounts or Avionics_PWR changes

	      return () => clearTimeout(timerId);
	    }
	  }, [Avionics_PWR]); // Set the corresponding ref to false after the initial render
	  ...
	  return /*#__PURE__*/jsxRuntime.jsxs("g", {
	    children: [/*#__PURE__*/jsxRuntime.jsx(Airdrop_CAWS, {}), /*#__PURE__*/jsxRuntime.jsx("text", {
	      x: 0,
	      y: 50,
	      fontSize: 100,
	      fill: "white",
	...
	const MasterCaution = () => {
	  let [MasterCaution, setMasterCaution] = useSimVar('L:C17_ALERT_MASTER_CAUTION', 'bool'); // Define an array of triggering conditions

	  const fuelQuantity = useSimVar('A:FUEL TOTAL QUANTITY WEIGHT', 'pounds')[0];
	  const triggeringConditions = [useSimVar('L:AnotherCondition', 'bool')[0], useSimVar('L:YetAnotherCondition', 'bool')[0], useSimVar('L:C17_ALERT_WACS_FAIL', 'bool')[0], fuelQuantity <= 16000 // Check if the fuel quantity is equal to 16000
	  ...
	  react.useEffect(() => {
	    if (triggeringConditions.some(condition => condition)) {
	      ...
	      }, delay); // Cleanup the timer if the component unmounts or if any triggering condition changes
	...
	render( /*#__PURE__*/jsxRuntime.jsx(Systems, {}));
