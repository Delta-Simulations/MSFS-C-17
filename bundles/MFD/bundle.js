(function () {
	...
	*/
	...
	const spacing$1 = 2.0;
	const offset$1 = -0;
	const enhancedSpacing = 9.9;
	const additionalEnhancedOffset = 290; // need to adjust the offset of the non enhanced markings dynamically based off the length of the selected altitude

	const SmallTick$1 = (y, enhanced, selectedAltitude) => {
	  let correctedY = enhanced ? y * enhancedSpacing + offset$1 : y / spacing$1 + offset$1;
	  const topOfEnhanced = getScopeOfEnhancedRes(selectedAltitude);
	  let correctedOffset = (selectedAltitude === 0 ? 5001 : topOfEnhanced) * enhancedSpacing + offset$1 + additionalEnhancedOffset;
	  let nonEnhancedY = y * spacing$1 + correctedOffset / 1.285;

	  if (!enhanced) {
	    return /*#__PURE__*/jsxRuntime.jsx("path", {
	      d: "M 648, ".concat(-nonEnhancedY, " L 663 ").concat(-nonEnhancedY),
	      stroke: "white",
	      strokeWidth: 3,
	      strokeLinecap: "round"
	    });
	    ...
	    return /*#__PURE__*/jsxRuntime.jsx("path", {
	      d: "M 648, ".concat(-correctedY, " L 663 ").concat(-correctedY),
	      stroke: "white",
	      strokeWidth: 3,
	      strokeLinecap: "round"
	    });
	...
	const largeTickWithNumber$1 = (y, enhanced, selectedAltitude) => {
	  let correctedY = enhanced ? y * enhancedSpacing + offset$1 : y / spacing$1 + offset$1;
	  const topOfEnhanced = getScopeOfEnhancedRes(selectedAltitude);
	  let correctedOffset = (selectedAltitude === 0 ? 5001 : topOfEnhanced) * enhancedSpacing + offset$1 + additionalEnhancedOffset;
	  let nonEnhancedY = y * spacing$1 + correctedOffset / 1.285;
	  ...
	  if (!enhanced) {
	    return /*#__PURE__*/jsxRuntime.jsxs("g", {
	      children: [/*#__PURE__*/jsxRuntime.jsx("path", {
	        d: "M 648, ".concat(-nonEnhancedY, " L 675 ").concat(-nonEnhancedY),
	        stroke: "white",
	        strokeWidth: 3,
	        strokeLinecap: "round"
	    ...
	    return /*#__PURE__*/jsxRuntime.jsxs("g", {
	      children: [/*#__PURE__*/jsxRuntime.jsx("path", {
	        d: "M 648, ".concat(-correctedY, " L 675 ").concat(-correctedY),
	        stroke: "white",
	        strokeWidth: 3,
	        strokeLinecap: "round"
	      }), /*#__PURE__*/jsxRuntime.jsx("text", {
	...
	const getScopeOfEnhancedRes = selectedAlt => {
	  if (selectedAlt === 0) {
	    return 5001;
	  } else {
	...
	const drawTick$1 = (shouldDrawEnhanced, selectedAltitude, cvalue, skipNormalRange) => {
	  let value = cvalue - 50;
	  ...
	  if (shouldDrawEnhanced && value < topOfEnhanced) {
	    if (value % 10 === 0) {
	      return largeTickWithNumber$1(value, true, selectedAltitude);
	    } else if (value % 2 === 0) {
	      return SmallTick$1(value, true, selectedAltitude);
	    } else return /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {});
	  } else if (!skipNormalRange) {
	    if (value % 50 === 0) {
	      return largeTickWithNumber$1(value, false, selectedAltitude);
	    } else if (value % 10 === 0) {
	      return SmallTick$1(value, false, selectedAltitude);
	    }
	  }
	...
	const AltitudeTape = props => {
	  ...
	  react.useEffect(() => {
	    const newTape = speedArray.map(value => {
	      ...
	      if (skipNonEnhanced) {
	        return drawTick$1(props.drawEnhanced, props.selectedAltitude / 10, value, true);
	      } else {
	        return drawTick$1(props.drawEnhanced, props.selectedAltitude / 10, value, false);
	      }
	    });
	    setTape(newTape);
	  }, [props.selectedAltitude, props.drawEnhanced]); // dealing with the translation: going to set a const var that gets the top of the enhanced tape, if we are above the enhanced we will do the math for the translation in the enhanced region and get the final translation value for the top, then we can just add that to our new translation formula as an offset

	  const topOfEnhanced = getScopeOfEnhancedRes(props.selectedAltitude);

	  const getTranslation = (altitude, topOfEnhanced) => {
	    let clampedAltitude = Math.min(altitude, 50010); // i fw ghetto ah solutions

	    let offset = 350;
	    let enhancedFactor = 0.99;
	    let normalFactor = 0.2; // translation in the enhanced region is literally almost 1 to 1 with the altitude
	  ...
	  return /*#__PURE__*/jsxRuntime.jsxs("g", {
	    children: [/*#__PURE__*/jsxRuntime.jsx("defs", {
	      ...
	      clipPath: "url(#AltitudeClip)",
	      children: /*#__PURE__*/jsxRuntime.jsx("g", {
	        transform: "translate(0,".concat(getTranslation(props.altitude, topOfEnhanced), ")"),
	        children: tape
	      })
	    })]
	  });
	...
	const Altitude = props => {
	  return /*#__PURE__*/jsxRuntime.jsxs("g", {
	    children: [/*#__PURE__*/jsxRuntime.jsx(AltitudeTape, {
	      altitude: props.altitude,
	      selectedAltitude: props.selectedAltitude,
	      drawEnhanced: props.drawEnhanced
	    }), /*#__PURE__*/jsxRuntime.jsx(AltitudeScroller, {
	      altitude: props.altitude
	    })]
	  });
	};

	const AirspeedScroller = props => {
	  return /*#__PURE__*/jsxRuntime.jsx("g", {
	    children: /*#__PURE__*/jsxRuntime.jsx("path", {
	...
	const SelectedAirspeedBug = props => {
	  return /*#__PURE__*/jsxRuntime.jsx("g", {
	    transform: "translate(".concat(props.x, ",").concat(props.y, ")"),
	    children: /*#__PURE__*/jsxRuntime.jsx("path", {
	      d: "M 20, 0 L 2 15 L 20 30 ".concat(!props.single && 'M 30,0 L 12 15 L 30 30'),
	      stroke: "cyan",
	      fill: "transparent",
	      strokeLinecap: "round",
	      strokeWidth: 3,
	...
	// 40 - 450 knots range
	const spacing = 5; // spacing of tape, will fuck offset so they must be changed in unison

	const offset = 348; // starting y offset of tape

	const SmallTick = y => {
	  let correctedYValue = y * spacing + offset;
	  if (y > 200) correctedYValue = (y / 2.5 + 120) * spacing + offset;
	  return /*#__PURE__*/jsxRuntime.jsx("path", {
	    d: "M 125, ".concat(correctedYValue, " L 140 ").concat(correctedYValue),
	    stroke: "white",
	    strokeWidth: 3,
	    strokeLinecap: "round"
	  });
	...
	const zeroTickMarker = () => {
	  ...
	  return /*#__PURE__*/jsxRuntime.jsxs("g", {
	    children: [/*#__PURE__*/jsxRuntime.jsx("path", {
	      d: "M 112, ".concat(correctedYValue, " L 140 ").concat(correctedYValue),
	      stroke: "white",
	      strokeWidth: 3,
	      strokeLinecap: "round"
	    }), /*#__PURE__*/jsxRuntime.jsx("text", {
	...
	const AirspeedTape = props => {
	  const speedArray = createArray(451);
	  const zeroMarker = zeroTickMarker();
	  const tape = speedArray.map(value => {
	    return drawTick(value);
	  });
	  const [translatedAirspeedValue, setTranslatedAirspeedValue] = react.useState(0);
	  const [selectedAirspeedY, setSelectedAirspeedY] = react.useState(0);
	  const [shouldTranslateBug, setShouldTranslateBug] = react.useState(false);
	  const [translateAbove200, setTranslateAbove200] = react.useState(false);
	  react.useEffect(() => {
	  ...
	  }, [props.selectedAirspeed, props.airspeed, selectedAirspeedY]); // this shit was a massive pain in the ass to make ngl
	  ...
	  return /*#__PURE__*/jsxRuntime.jsxs("g", {
	    children: [/*#__PURE__*/jsxRuntime.jsx("defs", {
	      ...
	      clipPath: "url(#AirspeedClip)",
	      children: /*#__PURE__*/jsxRuntime.jsxs("g", {
	        transform: "translate(0, ".concat(-translatedAirspeedValue * 5, ")"),
	        children: [props.airspeed >= 30 && zeroMarker, tape]
	      })
	    }), shouldTranslateBug ? /*#__PURE__*/jsxRuntime.jsx("g", {
	      transform: "translate(0, ".concat(-translatedAirspeedValue * 5, ")"),
	      children: /*#__PURE__*/jsxRuntime.jsx(SelectedAirspeedBug, {
	        single: true,
	        x: 135,
	        y: selectedAirspeedY
	      })
	    }) : /*#__PURE__*/jsxRuntime.jsx(SelectedAirspeedBug, {
	      x: 135,
	      y: selectedAirspeedY
	    })]
	  });
	...
	const Airspeed = props => {
	  return /*#__PURE__*/jsxRuntime.jsxs("g", {
	    children: [/*#__PURE__*/jsxRuntime.jsx(AirspeedTape, {
	      airspeed: props.airspeed,
	      selectedAirspeed: props.selectedAirspeed
	    }), /*#__PURE__*/jsxRuntime.jsx(AirspeedScroller, {
	      airspeed: props.airspeed
	    })]
	  });
	};

	const PFDProvider = props => {
	  return /*#__PURE__*/jsxRuntime.jsxs("svg", {
	    viewBox: "0 0 800 800",
	    className: "pfd-provider-svg",
	    children: [/*#__PURE__*/jsxRuntime.jsx(Heading, {
	      heading: props.vars.heading,
	      selectedHeading: props.vars.selectedHeading
	    }), /*#__PURE__*/jsxRuntime.jsx(Attitude, {
	      pitch: props.vars.pitch,
	      bank: props.vars.bank
	    }), /*#__PURE__*/jsxRuntime.jsx(Altitude, {
	      altitude: props.vars.altitude,
	      selectedAltitude: props.vars.selectedAltitude,
	      drawEnhanced: props.vars.useEnhanced
	    }), /*#__PURE__*/jsxRuntime.jsx(Airspeed, {
	      airspeed: props.vars.airspeed,
	      selectedAirspeed: props.vars.selectedAirspeed
	    })]
	  });
	};
	...
	const PFD = () => {
	  ...
	  return /*#__PURE__*/jsxRuntime.jsx(PFDProvider, {
	    vars: fillerData
	  });
	};
	...
	const MFD = () => {
	  return /*#__PURE__*/jsxRuntime.jsx("div", {
	    className: "MFD",
	    children: /*#__PURE__*/jsxRuntime.jsx(PFD, {})
	  });
	};

	render( /*#__PURE__*/jsxRuntime.jsx(MFD, {}));
