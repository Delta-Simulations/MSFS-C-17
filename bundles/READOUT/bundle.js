	...
	*/
	...
	const WACAP = props => {
	  ...
	  react.useEffect(() => {
	    const messages = [{
	      id: 1,
	      message: 'PARK BRAKE ON L, R',
	      condition: WACAP_Test || Park_brake
	    }, {
	      id: 2,
	      message: 'LANDING/TAXI LTS',
	      condition: WACAP_Test || Landing_light || Taxi_light
	    }, {
	      id: 4,
	      message: 'FUEL LOW',
	      ...
	      condition: WACAP_Test || Speed_brake
	    }, {
	      id: 6,
	      message: 'RAMP OPEN',
	      ...
	      id: 7,
	      message: 'SLAT OVERRIDE',
	      condition: WACAP_Test || SlatDisable
	  ...
	  return /*#__PURE__*/jsxRuntime.jsxs("g", {
	    children: [displayedMessages.map((message, index) => /*#__PURE__*/jsxRuntime.jsx("text", {
	      x: 670,
	      y: 609 + index * 13,
	      fontSize: 15,
	      fill: "#00EE00",
	    ...
	    }, message.id)), remainingMessages > 0 && /*#__PURE__*/jsxRuntime.jsxs("g", {
	      className: "scroll-symbols",
	      children: [/*#__PURE__*/jsxRuntime.jsx("text", {
	        x: 650,
	        y: 615 + maxMessages * 23,
	        fontSize: 16,
	        fill: "#00EE00",
	        children: "\u2191"
	      }), /*#__PURE__*/jsxRuntime.jsx("text", {
	        x: 650,
	        y: 638 + maxMessages * 23,
	        fontSize: 16,
	        fill: "#00EE00",
	        children: "\u2193"
	      })]
	...
	const RadioDisp = () => {
	  let [SimRate] = useSimVar('E:SIMULATION RATE', 'number');
	  ...
	  switch (Active_COM) {
	    ...
	    case 9:
	      DispMode = "TAC";
	      DispActiveFreq = "".concat(Tacan_Active_Freq).concat(Tacan_Active_Mode ? "Y" : "X");
	      DispStbyFreq = "".concat(Tacan_Stby_Freq).concat(Tacan_Stby_Mode ? "Y" : "X");
	      break;

	    case 10:
	      DispMode = "LF-ADF";
	      DispActiveFreq = "".concat(ADF_Active_Freq);
	      DispStbyFreq = "".concat(ADF_Stby_Freq);
	      break;

	    case 11:
	      DispMode = "IFF";
	      DispActiveFreq = "".concat(Ident_Code);
	      DispStbyFreq = "";
	      break;
	  ...
	  return /*#__PURE__*/jsxRuntime.jsxs("g", {
	    children: [/*#__PURE__*/jsxRuntime.jsx("image", {
	      ...
	      x: 3,
	      y: 754,
	      xlinkHref: "/Images/RadioStack.png",
	      height: 276,
	      opacity: 0.7
	    }), /*#__PURE__*/jsxRuntime.jsx("rect", {
	      visibility: ReverseThrust ? 'visible' : 'hidden',
	      x: 25,
	      y: 767,
	      width: 128,
	      height: 19,
	      ...
	      visibility: Ident_Active == 1 ? 'visible' : 'hidden',
	      x: 76,
	      y: 963,
	      fontSize: 19,
	      fill: "#00EE00",
	      ...
	      className: "Radio",
	      textAnchor: "start",
	      children: SecureComms
	    }), /*#__PURE__*/jsxRuntime.jsx("text", {
	      x: Active_COM === 9 ? 260 : 146,
	      y: 932,
	      fontSize: 34,
	      fill: "rgb(245, 255, 137)",
	      className: "Radio",
	      textAnchor: Active_COM === 9 ? 'end' : 'start',
	      children: WACAP_Test ? '888.888' : DispActiveFreq
	    }), /*#__PURE__*/jsxRuntime.jsx("text", {
	      x: Active_COM === 9 ? 110 : 52,
	      y: 925,
	      fontSize: 22,
	      fill: "rgb(245, 255, 137)",
	      className: "Radio",
	      textAnchor: Active_COM === 9 ? 'end' : 'start',
	      children: WACAP_Test ? '888.888' : DispStbyFreq
	    }), /*#__PURE__*/jsxRuntime.jsx("text", {
	      visibility: Active_COM <= 6 && 0 < Active_COM ? 'visible' : 'hidden',
	      x: 36,
	      y: 1016,
	      fontSize: 19,
	      fill: "#00EE00",
	      ...
	      visibility: Active_COM === 1 || Active_COM === 2 ? 'visible' : 'hidden',
	      x: 89,
	      y: 1016,
	      fontSize: 19,
	      fill: "#00EE00",
	      ...
	      visibility: (Active_COM === 1 || Active_COM === 2) && KHz_tune ? 'visible' : 'hidden',
	      x: 119.1,
	      y: 1000,
	      width: 45,
	      height: 19,
	      ...
	      visibility: Active_COM <= 6 && 0 < Active_COM && SQL_active ? 'visible' : 'hidden',
	      x: 178,
	      y: 1000,
	      width: 37,
	      height: 19,
	      ...
	      visibility: Active_COM <= 6 && 0 < Active_COM && GRD_active ? 'visible' : 'hidden',
	      x: 284.5,
	      y: 1000,
	      width: 37,
	      height: 19,
	      ...
	      visibility: Active_COM === 3 ? 'visible' : 'hidden',
	      x: 89,
	      y: 1016,
	      fontSize: 18,
	      fill: "#00EE00",
	      ...
	      visibility: Active_COM === 5 || Active_COM === 6 ? 'visible' : 'hidden',
	      x: 85,
	      y: 1016,
	      fontSize: 18,
	      fill: "#00EE00",
	      ...
	      visibility: Active_COM === 7 || Active_COM === 8 ? 'visible' : 'hidden',
	      x: 36,
	      y: 1016,
	      fontSize: 18,
	      fill: "#00EE00",
	      ...
	      visibility: Active_COM === 10 ? 'visible' : 'hidden',
	      x: 36,
	      y: 1016,
	      fontSize: 18,
	      fill: "#00EE00",
	      ...
	      visibility: Active_COM === 11 ? 'visible' : 'hidden',
	      x: 36,
	      y: 1016,
	      fontSize: 18,
	      fill: "#00EE00",
	      ...
	      visibility: Active_COM === 9 ? 'visible' : 'hidden',
	      children: [/*#__PURE__*/jsxRuntime.jsx("text", {
	        x: 89,
	        y: 1016,
	        fontSize: 18,
	...
	const StbyEngDisp = props => {
	  ...
	  return /*#__PURE__*/jsxRuntime.jsxs("g", {
	    children: [/*#__PURE__*/jsxRuntime.jsx("rect", {
	      ...
	      visibility: DispMode ? 'visible' : 'hidden',
	      children: [/*#__PURE__*/jsxRuntime.jsx("text", {
	        x: 825,
	        y: 873,
	        fontSize: 19,
	        ...
	        className: "FrontPNL",
	        textAnchor: "end",
	        children: DispMode === 1 ? N2Eng1 : EPREng1
	      }), /*#__PURE__*/jsxRuntime.jsx("text", {
	        x: 724,
	        y: 945,
	        fontSize: 40,
	        ...
	        className: "FrontPNL",
	        textAnchor: "end",
	        children: DispMode === 1 ? N2Eng2 : EPREng2
	      }), /*#__PURE__*/jsxRuntime.jsx("text", {
	        x: 796,
	        y: 945,
	        fontSize: 40,
	        ...
	        className: "FrontPNL",
	        textAnchor: "end",
	        children: DispMode === 1 ? N2Eng3 : EPREng3
	      }), /*#__PURE__*/jsxRuntime.jsx("text", {
	        x: 916,
	        y: 945,
	        fontSize: 40,
	        ...
	        className: "FrontPNL",
	        textAnchor: "end",
	        children: DispMode === 1 ? N2Eng4 : EPREng4
	      }), /*#__PURE__*/jsxRuntime.jsx("text", {
	        x: 988,
	        y: 945,
	        fontSize: 40,
	...
	const WACAP_Left = props => {
	  ...
	  react.useEffect(() => {
	    const messages = [{
	      id: 1,
	      message: 'IRU INOP 1',
	      condition: !IRU_1 && IRU_2
	    }, {
	      id: 2,
	      message: 'IRU INOP 2',
	      condition: !IRU_2 && IRU_1
	    }, {
	      id: 3,
	      message: 'IRU INOP 1,2',
	      condition: WACAP_Test || !IRU_1 && !IRU_2
	    }, {
	      id: 4,
	      message: 'ANTI ICE 1',
	      condition: !AntiIceEng1 && AntiIceEng2
	    }, {
	      id: 5,
	      message: 'ANTI ICE 2',
	      condition: !AntiIceEng2 && AntiIceEng1
	    }, {
	      id: 6,
	      message: 'ANTI ICE 1,2',
	      condition: WACAP_Test || !AntiIceEng1 && !AntiIceEng2
	    }, {
	      id: 7,
	      message: 'ENG OIL PRESS 1',
	      condition: OilPressEng1 < 70 && OilPressEng2 > 70
	    }, {
	      id: 8,
	      message: 'ENG OIL PRESS 2',
	      condition: OilPressEng2 < 70 && OilPressEng1 > 70
	    }, {
	      id: 9,
	      message: 'ENG OIL PRESS 1,2',
	      condition: WACAP_Test || OilPressEng1 < 70 && OilPressEng2 < 70
	    }, {
	      id: 11,
	      message: 'AURAL WARNING INOP',
	      condition: WACAP_Test
	    }, {
	      id: 10,
	      message: 'ENTRY DOOR',
	      condition: WACAP_Test || EnteranceDoor
	    }, {
	      id: 12,
	      message: 'GPWS FAIL',
	      condition: WACAP_Test || !MAIN_PWR
	    }, {
	      id: 13,
	      message: 'L TROOP DOOR',
	      condition: WACAP_Test || Para_L
	    }, {
	      id: 14,
	      message: 'A/R MODE INOP',
	      condition: WACAP_Test || !MAIN_PWR
	    }, {
	      id: 15,
	      message: 'RADAR ALT 1',
	      ...
	      id: 16,
	      message: 'PROBE HEATER',
	      condition: WACAP_Test || !Pitot_L
	    }, {
	      id: 17,
	      message: 'P/S 1A, 1B HEAD HTR',
	      condition: WACAP_Test || !MAIN_PWR
	    } // Add more caution messages here...
	    ];
	    setCautionMessages(messages);
	  }, [WACAP_Test, Pitot_L, MAIN_PWR, MAIN_PWR, MAIN_PWR, WACAP_Test, EnteranceDoor, IRU_1, IRU_2, AntiIceEng1, AntiIceEng2, OilPressEng1, OilPressEng2, Para_L]);
	  const maxMessages = 14;
	  const visibleMessages = cautionMessages.filter(message => message.condition);
	  const remainingMessages = Math.max(0, visibleMessages.length - maxMessages); // Calculate the maximum value for Scroll_L

	  const maxScroll = Math.max(0, remainingMessages); // Ensure that Scroll_L does not exceed maxScroll

	  const clampedScroll_L = Math.min(Scroll_L, maxScroll); // Calculate the displayed messages based on clampedScroll_L
	...
	const WACAP_Right = props => {
	  ...
	  react.useEffect(() => {
	    const messages = [{
	      id: 1,
	      message: 'IRU INOP 3',
	      condition: !IRU_3 && IRU_4
	    }, {
	      id: 2,
	      message: 'IRU INOP 4',
	      condition: !IRU_4 && IRU_3
	    }, {
	      id: 3,
	      message: 'IRU INOP 3,4',
	      condition: WACAP_Test || !IRU_3 && !IRU_4
	    }, {
	      id: 4,
	      message: 'APU',
	      condition: WACAP_Test || APU_ON > 95
	    }, {
	      id: 5,
	      message: 'ANTI ICE 3',
	      condition: !AntiIceEng3 && AntiIceEng4
	    }, {
	      id: 6,
	      message: 'ANTI ICE 4',
	      condition: !AntiIceEng4 && AntiIceEng3
	    }, {
	      id: 7,
	      message: 'ANTI ICE 3,4',
	      condition: WACAP_Test || !AntiIceEng4 && !AntiIceEng3
	    }, {
	      id: 8,
	      message: 'ENG OIL PRESS 3',
	      condition: OilPressEng3 < 70 && OilPressEng4 > 70
	    }, {
	      id: 9,
	      message: 'ENG OIL PRESS 4',
	      condition: OilPressEng4 < 70 && OilPressEng3 > 70
	    }, {
	      id: 10,
	      message: 'ENG OIL PRESS 3,4',
	      condition: WACAP_Test || OilPressEng3 < 70 && OilPressEng4 < 70
	    }, {
	      id: 11,
	      message: 'R TROOP DOOR',
	      condition: WACAP_Test || Para_R
	    }, {
	      id: 12,
	      message: 'AERO-I INOP',
	      condition: WACAP_Test || !MAIN_PWR
	      ...
	      id: 14,
	      message: 'PROBE HEATER',
	      condition: WACAP_Test || !Pitot_R
	    }, {
	      id: 15,
	      message: 'EMERGENCY PWR',
	      condition: WACAP_Test || !Emer_Pwr
	    }, {
	      id: 16,
	      message: 'P/S 2A, 2B HEAD HTR',
	      condition: WACAP_Test || !MAIN_PWR
	    } // Add more caution messages here...
	    ];
	    setCautionMessages(messages);
	  ...
	  const clampedScroll_L = Math.min(Scroll_R, maxScroll); // Calculate the displayed messages based on clampedScroll_L
	...
	const WACAP_Warning = props => {
	  ...
	  react.useEffect(() => {
	    const messages = [{
	      id: 1,
	      message: 'APU FIRE',
	      condition: WACAP_Test || APU_FIRE
	    }, {
	      id: 2,
	      message: 'OBIGG MANIFOLD L,R',
	      condition: WACAP_Test
	    }, {
	      id: 3,
	      message: 'CABIN PRESS LOW',
	      condition: WACAP_Test
	    }, {
	      id: 4,
	      message: 'TRIM AIR MANIFOLD',
	      condition: WACAP_Test
	    }, {
	      id: 5,
	      message: 'PITCH AUTHORITY',
	      condition: WACAP_Test || PCH_AUTHORITY
	    } // Add more caution messages here...
	    ];
	    setCautionMessages(messages);
	  ...
	  return /*#__PURE__*/jsxRuntime.jsx("g", {
	    children: displayedMessages.map((message, index) => /*#__PURE__*/jsxRuntime.jsxs("text", {
	      x: 670,
	      y: 713 + index * 13,
	      fontSize: 15,
	      fill: "yellow",
