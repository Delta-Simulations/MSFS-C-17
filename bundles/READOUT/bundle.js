(function () {
	...
	*/
	...
	const Ap_Disp = props => {
	  ...
	  let [AP_VertSpd] = useSimVar('AUTOPILOT VERTICAL HOLD VAR', 'feet per minute'); // useEffect(() => console.log(AP_VertSpd), [AP_VertSpd])
	  ...
	  useSimVar('A:TURB ENG BLEED AIR:1', 'psi');
	  useSimVar('A:TURB ENG BLEED AIR:2', 'psi');
	  useSimVar('A:TURB ENG BLEED AIR:3', 'psi');
	  useSimVar('A:TURB ENG BLEED AIR:4', 'psi');
	  useSimVar('A:APU BLEED PRESSURE RECEIVED BY ENGINE', 'psi');
	  useSimVar('ENG HYDRAULIC PRESSURE:1', 'psf');
	  useSimVar('ENG HYDRAULIC PRESSURE:2', 'psf');
	  useSimVar('ENG HYDRAULIC PRESSURE:3', 'psf');
	  useSimVar('ENG HYDRAULIC PRESSURE:4', 'psf');
	...
	const WACAP = props => {
	  ...
	  return /*#__PURE__*/jsxRuntime.jsxs("g", {
	    children: [/*#__PURE__*/jsxRuntime.jsx("text", {
	      ...
	      y: 615,
	      fontSize: 30,
	      visibility: WACAP_Test || Park_brake ? 'visible' : 'hidden',
	      fill: "#FF0000",
	      className: "WAPanel",
	      textAnchor: "middle",
	      children: "PARK BRAKE"
	      ...
	      y: 638,
	      fontSize: 30,
	      visibility: WACAP_Test || Landing_light ? 'visible' : 'hidden',
	      fill: "#FF0000",
	      className: "WAPanel",
	      textAnchor: "middle",
	      children: "LANDING LIGHT"
	    }), /*#__PURE__*/jsxRuntime.jsx("text", {
	      x: 670,
	      y: 661,
	      fontSize: 30,
	      visibility: WACAP_Test || Taxi_light ? 'visible' : 'hidden',
	      fill: "#FF0000",
	      className: "WAPanel",
	      textAnchor: "middle",
	      children: "TAXI LIGHT"
	      ...
	      y: 684,
	      fontSize: 30,
	      visibility: WACAP_Test || Fuel_quantity <= 12310 ? 'visible' : 'hidden',
	      fill: "#FF0000",
	      className: "WAPanel",
	      textAnchor: "middle",
	      children: "FUEL LOW"
	      ...
	      y: 707,
	      fontSize: 30,
	      visibility: WACAP_Test || Speed_brake ? 'visible' : 'hidden',
	      fill: "#FF0000",
	      className: "WAPanel",
	      textAnchor: "middle",
	      children: "SPOILERS"
	      ...
	      y: 730,
	      fontSize: 30,
	      visibility: WACAP_Test || Cargo_door ? 'visible' : 'hidden',
	      fill: "#CCFF33",
	      className: "WAPanel",
	      textAnchor: "middle",
	      children: "RAMP OPEN"
	...
	const StbyEngDisp = props => {
	  ...
	  useSimVar('A:Turb Eng2 N1', 'percent');
	  useSimVar('A:Turb Eng2 corrected N2', 'percent');
	  ...
	  useSimVar('A:Turb Eng3 N1', 'percent');
	  useSimVar('A:Turb Eng3 corrected N2', 'percent');
	    ...
	    children: /*#__PURE__*/jsxRuntime.jsxs("svg", {
	      ...
	      children: [/*#__PURE__*/jsxRuntime.jsx("rect", {
	        ...
	        children: [/*#__PURE__*/jsxRuntime.jsx("image", {
	          ...
	          height: 220,
	          opacity: 0.7
	        }), /*#__PURE__*/jsxRuntime.jsx(Ap_Disp, {}), /*#__PURE__*/jsxRuntime.jsx(WACAP, {}), /*#__PURE__*/jsxRuntime.jsx(StbyEngDisp, {}), /*#__PURE__*/jsxRuntime.jsx(RadioDisp, {}), /*#__PURE__*/jsxRuntime.jsx("image", {
	          visibility: HUD_OVERLAY ? 'visible' : 'hidden',
	          x: 0,
	          y: 0,
