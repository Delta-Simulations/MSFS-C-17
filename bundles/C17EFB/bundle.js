(function () {
	...
	*/
	...
	function Nj(a) {
	  ...
	  oj.current = f;
	  X$1 = e;
	  null !== Y ? d = 0 : (U$1 = null, W$1 = 0, d = V$1);
	...
	// once typings is next to tsconfig.json, use those units
	...
	const useSimVar = function (name, unit) {
	  let maxStaleness = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
	...
	*/
	...
	const startTransitionImpl = React[START_TRANSITION$1];
	/**
	...
	*/
	...
	function prefix(value, length) {
	  switch (x$1(value, length)) {
	    ...
	    case 6968:
	    case 2756:
	      return a + value + r$4 + value + e$1 + value + value;
	    // flex, flex-direction
	    ...
	    case 4765:
	      ...
	      if (M(value) - 1 - length > 6) switch (O(value, length + 1)) {
	        ...
	        case 102:
	          return z$1(value, /(.+:)(.+)-([^]+)/, '$1' + a + '$2-$3' + '$1' + r$4 + (O(value, length + 3) == 108 ? '$3' : '$2-$3')) + value;
	        // (s)tretch
	...
	var isValidElementType$1 = function (a) {
	  return "string" === typeof a || "function" === typeof a || a === e || a === m || a === g || a === f || a === p || a === q || "object" === typeof a && null !== a && (a.$$typeof === t || a.$$typeof === r$3 || a.$$typeof === h || a.$$typeof === k || a.$$typeof === n || a.$$typeof === w || a.$$typeof === x || a.$$typeof === y || a.$$typeof === v);
	};
	var typeOf$1 = z;
	...
	var styled$4 = createStyled$2.bind(null);
	tags.forEach(function (tagName) {
	  styled$4[tagName] = styled$4(tagName);
	});
	...
	function StyledEngineProvider(props) {
	  ...
	  if (injectFirst || enableCssLayer) {
	    return /*#__PURE__*/jsxRuntime.jsx(CacheProvider, {
	      value: cache,
	      children: children
	    });
	  }
	...
	function styled$3(tag, options) {
	  const stylesFactory = styled$4(tag, options);
	...
	function useTheme$2() {
	  let defaultTheme = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : systemDefaultTheme$1;
	...
	function GlobalStyles(_ref) {
	  ...
	  return /*#__PURE__*/jsxRuntime.jsx(GlobalStyles$1, {
	    styles: globalStyles
	  });
	}
	...
	var require$$0$2 = reactIs_production;
	...
	function processStyleArg(callableStyle, _ref, layerName) {
	  ...
	  if (!!resolvedStylesArg && typeof resolvedStylesArg === 'object' && Array.isArray(resolvedStylesArg.variants)) {
	    const {
	      ...
	      otherStyles = _objectWithoutPropertiesLoose$1(resolvedStylesArg, _excluded2);
	...
	function createStyled$1() {
	  ...
	  return function (tag) {
	    ...
	    const {
	      ...
	      options = _objectWithoutPropertiesLoose$1(inputOptions, _excluded3);
	...
	function isMuiElement(element, muiNames) {
	  ...
	  return /*#__PURE__*/ /*#__PURE__*/react.isValidElement(element) && muiNames.indexOf(
	...
	function useSlotProps(parameters) {
	  ...
	  const {
	    ...
	    rest = _objectWithoutPropertiesLoose$1(parameters, _excluded$m);
	...
	const _excluded$l = ["value"];
	const RtlContext = /*#__PURE__*/react.createContext();
	function RtlProvider(_ref) {
	  let {
	      value
	    } = _ref,
	    props = _objectWithoutPropertiesLoose$1(_ref, _excluded$l);
	...
	function useLayerOrder(theme) {
	  ...
	  return /*#__PURE__*/jsxRuntime.jsx(GlobalStyles, {
	    styles: layerOrder
	  });
	}
	  ...
	  return /*#__PURE__*/jsxRuntime.jsx(ThemeProvider$2, {
	    ...
	    children: /*#__PURE__*/jsxRuntime.jsx(ThemeContext$2.Provider, {
	      ...
	      children: /*#__PURE__*/jsxRuntime.jsx(RtlProvider, {
	        value: rtlValue,
	        children: /*#__PURE__*/jsxRuntime.jsxs(DefaultPropsProvider, {
	...
	var require$$0$1 = /*@__PURE__*/getAugmentedNamespace(formatMuiErrorMessage);

	var require$$1 = /*@__PURE__*/getAugmentedNamespace(clamp);
	...
	var colorManipulator = createCommonjsModule(function (module, exports) {
	  ...
	  var _formatMuiErrorMessage2 = interopRequireDefault(require$$0$1);
	  var _clamp = interopRequireDefault(require$$1);
	...
	var _styledEngine = /*@__PURE__*/getAugmentedNamespace(styledEngine);

	var _deepmerge = /*@__PURE__*/getAugmentedNamespace(deepmerge);

	var require$$3 = /*@__PURE__*/getAugmentedNamespace(capitalize);

	var require$$4 = /*@__PURE__*/getAugmentedNamespace(getDisplayName);
	...
	var createStyled_1 = createCommonjsModule(function (module, exports) {
	  ...
	  var _styledEngine$1 = _interopRequireWildcard(_styledEngine);
	  interopRequireDefault(require$$3);
	  interopRequireDefault(require$$4);
	  var _createTheme = interopRequireDefault(require$$5);
	  var _styleFunctionSx = interopRequireDefault(require$$6);
	...
	var createStyled = /*@__PURE__*/getDefaultExportFromCjs(createStyled_1);
	...
	const SvgIcon = /*#__PURE__*/react.forwardRef(function SvgIcon(inProps, ref) {
	  ...
	  const hasSvgAsChild = /*#__PURE__*/ /*#__PURE__*/react.isValidElement(children) && children.type === 'svg';
	...
	const PaperRoot = styled$1('div', {
	  ...
	  return _extends$1({
	    ...
	    backgroundImage: "linear-gradient(".concat(colorManipulator.alpha('#fff', getOverlayAlpha$1(ownerState.elevation)), ", ").concat(colorManipulator.alpha('#fff', getOverlayAlpha$1(ownerState.elevation)), ")")
	  }, theme.vars && {
	...
	const TouchRippleRipple = styled$1(Ripple, {
	  name: 'MuiTouchRipple',
	  slot: 'Ripple'
	})(_t4 || (_t4 = _(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  opacity: 0;\n  position: absolute;\n\n  &.", " {\n    opacity: 0.3;\n    transform: scale(1);\n    animation-name: ", ";\n    animation-duration: ", "ms;\n    animation-timing-function: ", ";\n  }\n\n  &.", " {\n    animation-duration: ", "ms;\n  }\n\n  & .", " {\n    opacity: 1;\n    display: block;\n    width: 100%;\n    height: 100%;\n    border-radius: 50%;\n    background-color: currentColor;\n  }\n\n  & .", " {\n    opacity: 0;\n    animation-name: ", ";\n    animation-duration: ", "ms;\n    animation-timing-function: ", ";\n  }\n\n  & .", " {\n    position: absolute;\n    /* @noflip */\n    left: 0px;\n    top: 0;\n    animation-name: ", ";\n    animation-duration: 2500ms;\n    animation-timing-function: ", ";\n    animation-iteration-count: infinite;\n    animation-delay: 200ms;\n  }\n"])))), touchRippleClasses$1.rippleVisible, enterKeyframe, DURATION, _ref => {
	  let {
	    theme
	  } = _ref;
	  return theme.transitions.easing.easeInOut;
	}, touchRippleClasses$1.ripplePulsate, _ref2 => {
	  let {
	    theme
	  } = _ref2;
	  return theme.transitions.duration.shorter;
	}, touchRippleClasses$1.child, touchRippleClasses$1.childLeaving, exitKeyframe, DURATION, _ref3 => {
	  let {
	    theme
	  } = _ref3;
	  return theme.transitions.easing.easeInOut;
	}, touchRippleClasses$1.childPulsate, pulsateKeyframe, _ref4 => {
	  let {
	    theme
	  } = _ref4;
	  return theme.transitions.easing.easeInOut;
	...
	const useUtilityClasses$7 = ownerState => {
	  ...
	  const slots = {
	    root: ['root', "color".concat(capitalize$1(color)), "position".concat(capitalize$1(position))]
	  };
	...
	const AppBarRoot = styled$1(Paper$1, {
	  ...
	  overridesResolver: (props, styles) => {
	    ...
	    return [styles.root, styles["position".concat(capitalize$1(ownerState.position))], styles["color".concat(capitalize$1(ownerState.color))]];
	  }
	})(_ref => {
	  let {
	    theme,
	...
	const ButtonRoot = styled$1(ButtonBase$1, {
	  ...
	  return _extends$1({}, theme.typography.button, {
	    ...
	    '&:hover': _extends$1({
	      textDecoration: 'none',
	      backgroundColor: theme.vars ? "rgba(".concat(theme.vars.palette.text.primaryChannel, " / ").concat(theme.vars.palette.action.hoverOpacity, ")") : colorManipulator.alpha(theme.palette.text.primary, theme.palette.action.hoverOpacity),
	      // Reset on touch devices, it doesn't add specificity
	      '@media (hover: none)': {
	        backgroundColor: 'transparent'
	      }
	    }, ownerState.variant === 'text' && ownerState.color !== 'inherit' && {
	      backgroundColor: theme.vars ? "rgba(".concat(theme.vars.palette[ownerState.color].mainChannel, " / ").concat(theme.vars.palette.action.hoverOpacity, ")") : colorManipulator.alpha(theme.palette[ownerState.color].main, theme.palette.action.hoverOpacity),
	      // Reset on touch devices, it doesn't add specificity
	      '@media (hover: none)': {
	        backgroundColor: 'transparent'
	      }
	    ...
	    color: (theme.vars || theme).palette[ownerState.color].main,
	    border: theme.vars ? "1px solid rgba(".concat(theme.vars.palette[ownerState.color].mainChannel, " / 0.5)") : "1px solid ".concat(colorManipulator.alpha(theme.palette[ownerState.color].main, 0.5))
	  }, ownerState.variant === 'contained' && {
	    color: theme.vars ?
	...
	const _excluded$7 = ["children", "className", "color", "component", "disabled", "disableElevation", "disableFocusRipple", "disableRipple", "fullWidth", "orientation", "size", "variant"];
	const overridesResolver = (props, styles) => {
	  ...
	  return [{
	    ...
	    ["& .".concat(buttonGroupClasses$1.grouped)]: styles["grouped".concat(capitalize$1(ownerState.orientation))]
	  }, {
	    ["& .".concat(buttonGroupClasses$1.grouped)]: styles["grouped".concat(capitalize$1(ownerState.variant))]
	  }, {
	    ["& .".concat(buttonGroupClasses$1.grouped)]: styles["grouped".concat(capitalize$1(ownerState.variant)).concat(capitalize$1(ownerState.orientation))]
	  }, {
	    ["& .".concat(buttonGroupClasses$1.grouped)]: styles["grouped".concat(capitalize$1(ownerState.variant)).concat(capitalize$1(ownerState.color))]
	  }, {
	    ["& .".concat(buttonGroupClasses$1.firstButton)]: styles.firstButton
	  }, {
	    ["& .".concat(buttonGroupClasses$1.lastButton)]: styles.lastButton
	  }, {
	    ["& .".concat(buttonGroupClasses$1.middleButton)]: styles.middleButton
	...
	const ButtonGroupRoot = styled$1('div', {
	  ...
	  return _extends$1({
	    ...
	    ["& .".concat(buttonGroupClasses$1.firstButton, ",& .").concat(buttonGroupClasses$1.middleButton)]: _extends$1({}, ownerState.orientation === 'horizontal' && {
	      ...
	      borderColor: theme.vars ? "rgba(".concat(theme.vars.palette[ownerState.color].mainChannel, " / 0.5)") : colorManipulator.alpha(theme.palette[ownerState.color].main, 0.5)
	    ...
	    ["& .".concat(buttonGroupClasses$1.lastButton, ",& .").concat(buttonGroupClasses$1.middleButton)]: _extends$1({}, ownerState.orientation === 'horizontal' && {
	  ...
	  return /*#__PURE__*/jsxRuntime.jsx(ButtonGroupRoot, _extends$1({
	    ...
	    children: /*#__PURE__*/jsxRuntime.jsx(ButtonGroupContext$1.Provider, {
	      ...
	      children: validChildren.map((child, index) => {
	        return /*#__PURE__*/jsxRuntime.jsx(ButtonGroupButtonContext$1.Provider, {
	...
	const DividerRoot = styled$1('div', {
	  ...
	  return _extends$1({
	    ...
	    borderColor: theme.vars ? "rgba(".concat(theme.vars.palette.dividerChannel, " / 0.08)") : colorManipulator.alpha(theme.palette.divider, 0.08)
	  ...
	  return _extends$1({}, ownerState.children && {
	    display: 'flex',
	    whiteSpace: 'nowrap',
	    textAlign: 'center',
	    border: 0,
	  ...
	  return _extends$1({}, ownerState.children && ownerState.orientation !== 'vertical' && {
	    '&::before, &::after': {
	      width: '100%',
	  ...
	  return _extends$1({}, ownerState.textAlign === 'right' && ownerState.orientation !== 'vertical' && {
	    '&::before': {
	      width: '90%'
	    },
	    '&::after': {
	...
	const _excluded$5 = ["aria-label", "aria-valuetext", "aria-labelledby", "component", "components", "componentsProps", "color", "classes", "className", "disableSwap", "disabled", "getAriaLabel", "getAriaValueText", "marks", "max", "min", "name", "onChange", "onChangeCommitted", "orientation", "shiftStep", "size", "step", "scale", "slotProps", "slots", "tabIndex", "track", "value", "valueLabelDisplay", "valueLabelFormat"];
	function Identity(x) {
	  return x;
	}
	const SliderRoot = styled$1('span', {
	  ...
	  overridesResolver: (props, styles) => {
	    ...
	    return [styles.root, styles["color".concat(capitalize$1(ownerState.color))], ownerState.size !== 'medium' && styles["size".concat(capitalize$1(ownerState.size))], ownerState.marked && styles.marked, ownerState.orientation === 'vertical' && styles.vertical, ownerState.track === 'inverted' && styles.trackInverted, ownerState.track === false && styles.trackFalse];
	  }
	})(_ref9 => {
	  let {
	    theme
	  ...
	  return {
	    ...
	    ["&.".concat(sliderClasses$1.dragging)]: {
	      ["& .".concat(sliderClasses$1.thumb, ", & .").concat(sliderClasses$1.track)]: {
	        transition: 'none'
	      }
	    },
	  ...
	  return {
	    ...
	    variants: [{
	      ...
	      style: _extends$1({}, theme.vars ? {
	        ...
	        backgroundColor: colorManipulator.lighten(theme.palette[color].main, 0.62),
	        borderColor: colorManipulator.lighten(theme.palette[color].main, 0.62)
	      }, theme.applyStyles('dark', {
	        backgroundColor: colorManipulator.darken(theme.palette[color].main, 0.5)
	      }), theme.applyStyles('dark', {
	        borderColor: colorManipulator.darken(theme.palette[color].main, 0.5)
	      })))
	    }))]
	  };
	});
	const SliderThumb = styled$1('span', {
	  ...
	  return {
	    ...
	    variants: [{
	      ...
	      style: {
	        ["&:hover, &.".concat(sliderClasses$1.focusVisible)]: _extends$1({}, theme.vars ? {
	          boxShadow: "0px 0px 0px 8px rgba(".concat(theme.vars.palette[color].mainChannel, " / 0.16)")
	        } : {
	          boxShadow: "0px 0px 0px 8px ".concat(colorManipulator.alpha(theme.palette[color].main, 0.16))
	        }, {
	          '@media (hover: none)': {
	            boxShadow: 'none'
	          }
	        }),
	        ["&.".concat(sliderClasses$1.active)]: _extends$1({}, theme.vars ? {
	          boxShadow: "0px 0px 0px 14px rgba(".concat(theme.vars.palette[color].mainChannel, " / 0.16)")
	        } : {
	          boxShadow: "0px 0px 0px 14px ".concat(colorManipulator.alpha(theme.palette[color].main, 0.16))
	        })
	      }
	    }))]
	  };
	...
	const Slider = /*#__PURE__*/react.forwardRef(function Slider(inputProps, ref) {
	  ...
	  return /*#__PURE__*/jsxRuntime.jsxs(RootSlot, _extends$1({}, rootProps, {
	    children: [/*#__PURE__*/jsxRuntime.jsx(RailSlot, _extends$1({}, railProps)), /*#__PURE__*/jsxRuntime.jsx(TrackSlot, _extends$1({}, trackProps)), marks.filter(mark => mark.value >= min && mark.value <= max).map((mark, index) => {
	      ...
	      return /*#__PURE__*/jsxRuntime.jsxs(react.Fragment, {
	        children: [/*#__PURE__*/jsxRuntime.jsx(MarkSlot, _extends$1({
	          "data-index": index
	        ...
	        })), mark.label != null ? /*#__PURE__*/jsxRuntime.jsx(MarkLabelSlot, _extends$1({
	          "aria-hidden": true,
	          "data-index": index
	      ...
	      return /*#__PURE__*/ /* TODO v6: Change component structure. It will help in avoiding the complicated React.cloneElement API added in SliderValueLabel component. Should be: Thumb -> Input, ValueLabel. Follow Joy UI's Slider structure. */jsxRuntime.jsx(ValueLabelComponent, _extends$1({}, !isHostComponent(ValueLabelComponent) && {
	        valueLabelFormat,
	        valueLabelDisplay,
	        ...
	        children: /*#__PURE__*/jsxRuntime.jsx(ThumbSlot, _extends$1({
	          "data-index": index
	        }, thumbProps, {
	          className: clsx(classes.thumb, thumbProps.className, active === index && classes.active, focusedThumbIndex === index && classes.focusVisible),
	          style: _extends$1({}, style, getThumbStyle(index), thumbProps.style),
	          children: /*#__PURE__*/jsxRuntime.jsx(InputSlot, _extends$1({
	            "data-index": index,
	...
	const TabRoot = styled$1(ButtonBase$1, {
	  ...
	  overridesResolver: (props, styles) => {
	    ...
	    return [styles.root, ownerState.label && ownerState.icon && styles.labelIcon, styles["textColor".concat(capitalize$1(ownerState.textColor))], ownerState.fullWidth && styles.fullWidth, ownerState.wrapped && styles.wrapped, {
	      ["& .".concat(tabClasses$1.iconWrapper)]: styles.iconWrapper
	    }];
	  }
	})(_ref => {
	  let {
	...
	var KeyboardArrowLeft = createSvgIcon$1(/*#__PURE__*/jsxRuntime.jsx("path", {
	  d: "M15.41 16.09l-4.58-4.59 4.58-4.59L14 5.5l-6 6 6 6z"
	}), 'KeyboardArrowLeft');

	var KeyboardArrowRight = createSvgIcon$1(/*#__PURE__*/jsxRuntime.jsx("path", {
	...
	const TabScrollButton = /*#__PURE__*/react.forwardRef(function TabScrollButton(inProps, ref) {
	  ...
	  return /*#__PURE__*/jsxRuntime.jsx(TabScrollButtonRoot, _extends$1({
	    ...
	    children: direction === 'left' ? /*#__PURE__*/jsxRuntime.jsx(StartButtonIcon, _extends$1({}, startButtonIconProps)) : /*#__PURE__*/jsxRuntime.jsx(EndButtonIcon, _extends$1({}, endButtonIconProps))
	  }));
	});
	...
	*/
	...
	const Browser = () => {
	  ...
	  const [input, setInput] = react.useState("https://www.bing.com");
	  const goToPage = () => {
	    let formatted = input;
	...
	var CameraAlt = createCommonjsModule(function (module, exports) {
	  "use client";
	  ...
	  exports.default = (0, _createSvgIcon.default)([/*#__PURE__*/(0, jsxRuntime.jsx)("circle", {
	    cx: "12",
	    cy: "12",
	    r: "3.2"
	...
	var CameraAltIcon = /*@__PURE__*/getDefaultExportFromCjs(CameraAlt);
	...
	const Cargo = () => {
	  ...
	  return /*#__PURE__*/jsxRuntime.jsx("div", {
	    ...
	    children: /*#__PURE__*/jsxRuntime.jsxs(Box$1, {
	      ...
	      children: [/*#__PURE__*/jsxRuntime.jsx(ImagesCargo, {}), /*#__PURE__*/jsxRuntime.jsx(Box$1, {
	        sx: {
	          position: 'absolute',
	          width: 240,
	          height: 180,
	        ...
	        children: /*#__PURE__*/jsxRuntime.jsx(Stack$1, {
	          ...
	          children: /*#__PURE__*/jsxRuntime.jsxs(ThemeProvider, {
	            ...
	            children: [/*#__PURE__*/jsxRuntime.jsx("h3", {
	              ...
	              children: "Cargo Bay Lighting"
	            }), /*#__PURE__*/jsxRuntime.jsxs(ButtonGroup$1, {
	              variant: "outlined",
	              fullWidth: true,
	              children: [/*#__PURE__*/jsxRuntime.jsx(Button$1, {
	                onClick: () => setCargoHoldFlood(0),
	                children: "Off"
	              }), /*#__PURE__*/jsxRuntime.jsx(Button$1, {
	                onClick: () => setCargoHoldFlood(40),
	                children: "Dim"
	              }), /*#__PURE__*/jsxRuntime.jsx(Button$1, {
	                onClick: () => setCargoHoldFlood(100),
	                children: "Bright"
	              })]
	            }), /*#__PURE__*/jsxRuntime.jsxs(ButtonGroup$1, {
	              variant: "outlined",
	        ...
	        children: [/*#__PURE__*/jsxRuntime.jsxs(Box$1, {
	          ...
	          children: [/*#__PURE__*/jsxRuntime.jsx("h3", {
	            ...
	            children: [/*#__PURE__*/jsxRuntime.jsxs(ButtonGroup$1, {
	              ...
	              children: [/*#__PURE__*/jsxRuntime.jsx(Button$1, {
	                size: "large",
	                variant: cargoMode === 0 ? 'contained' : 'outlined',
	                onClick: () => setCargoMode(0),
	                children: "STATIC CARGO"
	              }), /*#__PURE__*/jsxRuntime.jsx(Button$1, {
	                size: "large",
	                variant: cargoMode === 1 ? 'contained' : 'outlined',
	                onClick: () => setCargoMode(1),
	                children: "AIRDROP CARGO"
	              })]
	            }), cargoMode === 0 && /*#__PURE__*/jsxRuntime.jsxs(ButtonGroup$1, {
	              fullWidth: true,
	              orientation: "horizontal",
	              "aria-label": "horizontal outlined button group",
	              children: [/*#__PURE__*/jsxRuntime.jsx(Button$1, {
	                size: "medium",
	                variant: CargoLoadout === 0 ? 'contained' : 'outlined',
	                onClick: () => {
	                  setFwdCargo_Station(0);
	                  setAftCargo_Station(0);
	                },
	                children: "EMPTY"
	              }), /*#__PURE__*/jsxRuntime.jsx(Button$1, {
	                size: "medium",
	                variant: CargoLoadout === 1 ? 'contained' : 'outlined',
	                onClick: () => {
	                  setFwdCargo_Station(14000);
	                  setAftCargo_Station(14000);
	                },
	                children: "PALLET"
	              }), /*#__PURE__*/jsxRuntime.jsx(Button$1, {
	                size: "medium",
	                variant: CargoLoadout === 2 ? 'contained' : 'outlined',
	                onClick: () => {
	                  setFwdCargo_Station(22000);
	                  setAftCargo_Station(22000);
	                },
	                children: "ISU"
	              }), /*#__PURE__*/jsxRuntime.jsx(Button$1, {
	                size: "medium",
	                variant: CargoLoadout === 3 ? 'contained' : 'outlined',
	                onClick: () => {
	                  setFwdCargo_Station(40000);
	                  setAftCargo_Station(40000);
	                },
	                children: "UH-60"
	              }), /*#__PURE__*/jsxRuntime.jsx(Button$1, {
	                size: "medium",
	                variant: CargoLoadout === 4 ? 'contained' : 'outlined',
	                onClick: () => {
	                  setFwdCargo_Station(50000);
	                  setAftCargo_Station(50000);
	                },
	                children: "FUEL BLADDER"
	              })]
	            }), cargoMode === 1 && /*#__PURE__*/jsxRuntime.jsxs(ButtonGroup$1, {
	              fullWidth: true,
	              orientation: "horizontal",
	              "aria-label": "horizontal outlined button group",
	              children: [/*#__PURE__*/jsxRuntime.jsx(Button$1, {
	                ...
	                size: "medium",
	                variant: CargoLoadout === 6 ? 'contained' : 'outlined',
	                onClick: () => {
	                  setFwdCargo_Station(10000);
	                  setAftCargo_Station(10000);
	                },
	                children: "PALLET"
	              })]
	            })]
	          })]
	        }), cargoMode === 1 && CargoLoadout === 6 && /*#__PURE__*/jsxRuntime.jsxs(Box$1, {
	          sx: {
	            position: 'absolute',
	            width: 350,
	            height: 155,
	          ...
	          children: [/*#__PURE__*/jsxRuntime.jsx("h3", {
	            ...
	            children: "Airdrop Configuration"
	          }), /*#__PURE__*/jsxRuntime.jsxs(Stack$1, {
	            direction: "column",
	            spacing: 1,
	            children: [/*#__PURE__*/jsxRuntime.jsxs(ButtonGroup$1, {
	              ...
	              children: [/*#__PURE__*/jsxRuntime.jsx(Button$1, {
	                size: "medium",
	                variant: airdrop_control_mode === 1 ? 'contained' : 'outlined',
	                onClick: () => setairdrop_control_mode(1),
	                children: "MANUAL DROP"
	              }), /*#__PURE__*/jsxRuntime.jsx(Button$1, {
	                size: "medium",
	                variant: airdrop_control_mode === 0 ? 'contained' : 'outlined',
	                onClick: () => setairdrop_control_mode(0),
	                children: "AUTO DROP"
	              })]
	            }), /*#__PURE__*/jsxRuntime.jsxs(Stack$1, {
	              direction: "column",
	          ...
	          startIcon: /*#__PURE__*/jsxRuntime.jsx(CameraAltIcon, {}),
	          onClick: () => {
	            setcamera_instrument_index(8);
	            setcamera_substate(2);
	          },
	          size: "large",
	          variant: "outlined",
	          style: {
