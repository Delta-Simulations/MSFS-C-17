(function () {
	...
	*/
	...
	function prefix(value, length) {
	  switch (x$1(value, length)) {
	    ...
	    case 6968:
	    case 2756:
	      return a + value + r$2 + value + e$1 + value + value;
	    // flex, flex-direction
	    ...
	    case 4765:
	      ...
	      if (M(value) - 1 - length > 6) switch (O(value, length + 1)) {
	        ...
	        case 102:
	          return z$1(value, /(.+:)(.+)-([^]+)/, '$1' + a + '$2-$3' + '$1' + r$2 + (O(value, length + 3) == 108 ? '$3' : '$2-$3')) + value;
	        // (s)tretch
	...
	*/
	      ...
	      children: [/*#__PURE__*/jsxRuntime.jsx(Images, {}), /*#__PURE__*/jsxRuntime.jsxs(Box$1, {
	        ...
	        children: [/*#__PURE__*/jsxRuntime.jsx(Box$1, {
	          ...
	          sx: {
	            ...
	            left: 884,
	            top: 645,
	            // adjust this to where you want it
	            position: 'absolute'
	          },
	          children: /*#__PURE__*/jsxRuntime.jsxs(ButtonGroup$1, {
	            orientation: "vertical",
	...
	const Cargo = () => {
	  ...
	  useSimVar('C:fs9gps:FlightPlanWaypointsNumber', 'number');
	          ...
	          children: [/*#__PURE__*/jsxRuntime.jsx("h3", {
	            ...
	            children: [/*#__PURE__*/jsxRuntime.jsxs(ButtonGroup$1, {
	              ...
	              children: [/*#__PURE__*/jsxRuntime.jsx(Button$1, {
	                ...
	                size: "medium",
	                variant: isPallet ? 'contained' : 'outlined',
	                onClick: () => {
	                ...
	                size: "medium",
	                variant: isISU ? 'contained' : 'outlined',
	                onClick: () => {
	                ...
	                size: "medium",
	                variant: isUH60 ? 'contained' : 'outlined',
	                onClick: () => {
	                  setFwdCargo_Station(35000);
	                  setAftCargo_Station(35000);
	                },
	                children: "UH-60"
	              }), /*#__PURE__*/jsxRuntime.jsx(Button$1, {
	                size: "medium",
	                variant: isFuel ? 'contained' : 'outlined',
	                onClick: () => {
	              ...
	              children: [/*#__PURE__*/jsxRuntime.jsx(Button$1, {
	                ...
	                size: "medium",
	                variant: isADSCargo ? 'contained' : 'outlined',
	                onClick: () => {
	                  setFwdCargo_Station(12000);
	                  setAftCargo_Station(12000);
	                },
	                children: "PALLET"
	              })]
	            })]
	          })]
	        }), cargoMode === 1 && isADSCargo && /*#__PURE__*/jsxRuntime.jsxs(Box$1, {
	          sx: {
	            position: 'absolute',
	            width: 350,
	            height: 155,
