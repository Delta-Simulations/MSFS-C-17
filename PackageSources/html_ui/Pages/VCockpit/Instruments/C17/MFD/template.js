...
class MFD_Logic extends BaseInstrument {
    constructor() {
        super();
    ...
    connectedCallback() {
        ...
        {
            const code = document.getElementById('MFD_BUNDLED_STYLE').innerHTML;
            const style = document.createElement('style');
            style.innerHTML = code;
            document.head.appendChild(style);
        }
        {
            const code = document.getElementById('MFD_BUNDLED_LOGIC').innerHTML;
...
registerInstrument('mfd-element', MFD_Logic);
