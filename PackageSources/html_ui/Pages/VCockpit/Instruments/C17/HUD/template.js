...
class HUD_Logic extends BaseInstrument {
    constructor() {
        super();
    ...
    connectedCallback() {
        ...
        {
            const code = document.getElementById('HUD_BUNDLED_STYLE').innerHTML;
            const style = document.createElement('style');
            style.innerHTML = code;
            document.head.appendChild(style);
        }
        {
            const code = document.getElementById('HUD_BUNDLED_LOGIC').innerHTML;
...
registerInstrument('hud-element', HUD_Logic);
