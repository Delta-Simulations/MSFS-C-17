...
class READOUT_Logic extends BaseInstrument {
    constructor() {
        super();
    ...
    connectedCallback() {
        ...
        {
            const code = document.getElementById('READOUT_BUNDLED_STYLE').innerHTML;
            const style = document.createElement('style');
            style.innerHTML = code;
            document.head.appendChild(style);
        }
        {
            const code = document.getElementById('READOUT_BUNDLED_LOGIC').innerHTML;
...
registerInstrument('readout-element', READOUT_Logic);
