...
class Systems_Logic extends BaseInstrument {
    constructor() {
        super();
    ...
    connectedCallback() {
        ...
        {
            const code = document.getElementById('Systems_BUNDLED_STYLE').innerHTML;
            const style = document.createElement('style');
            style.innerHTML = code;
            document.head.appendChild(style);
        }
        {
            const code = document.getElementById('Systems_BUNDLED_LOGIC').innerHTML;
...
registerInstrument('systems-element', Systems_Logic);
