        ...
        if (this.updateAutopilotCooldown < 0) {
            ...
            if (this.currentFlightPhase >= FlightPhase.FLIGHT_PHASE_DESCENT) {
                switch (Simplane.getFlapsHandleIndex()) {
                    case 5:
                        vRef = this.getSlatApproachSpeed(true);
                        break;
                    case 6:
                        vRef = this.getFlapApproachSpeed(true);
                        break;
                }
            }
            ...
            if (currentApMasterStatus && Simplane.getAPVNAVActive() === 1 && !(Simplane.getAutoPilotGlideslopeActive() || Simplane.getAutoPilotGlideslopeHold())) {
