...
declare const SimVar: any // this can also be replaced once /typings are available
 ...
 */
type T_SimVarProviderProps = {
  children: React.ReactNode
}

const SimVarProvider: React.FC<T_SimVarProviderProps> = ({ children }) => {
