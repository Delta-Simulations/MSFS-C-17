...
export const VSpeed_2 = () => {
  return (
    <g>
      <text x={499} y={982} fontSize={24} className="ESIS">
        0
      </text>
      <text x={499} y={927} fontSize={20} className="ESIS">
        1
      </text>
      <text x={499} y={900} fontSize={20} className="ESIS">
        2
      </text>
      <text x={499} y={875} fontSize={20} className="ESIS">
        3
      </text>

      <text x={499} y={1034} fontSize={20} className="ESIS">
        1
      </text>
      <text x={499} y={1060} fontSize={20} className="ESIS">
        2
      </text>
      <text x={499} y={1087} fontSize={20} className="ESIS">
        3
      </text>
