...
export const RadioDisp = () => {
  ...
  return (
    <g>
      ...
      <text x={14} y={813} fontSize={19} fill="#00EE00" className="Radio" textAnchor="start">
        COM
      </text>
      <text x={14} y={855} fontSize={19} fill="#00EE00" className="Radio" textAnchor="start">
        UHF
      </text>
      <text x={14} y={895} fontSize={19} fill="#00EE00" className="Radio" textAnchor="start">
        VHF
      </text>
      <text x={14} y={938} fontSize={19} fill="#00EE00" className="Radio" textAnchor="start">
        HF
      </text>
      <text x={324} y={813} fontSize={19} fill="#00EE00" className="Radio" textAnchor="end">
        NAV
      </text>
      <text x={324} y={855} fontSize={19} fill="#00EE00" className="Radio" textAnchor="end">
        TAC
      </text>
      <text x={324} y={895} fontSize={19} fill="#00EE00" className="Radio" textAnchor="end">
        ADF
      </text>
      <text x={324} y={938} fontSize={19} fill="#00EE00" className="Radio" textAnchor="end">
        IFF
      </text>
      <text x={198} y={902} fontSize={19} fill="#00EE00" className="Radio" textAnchor="start">
        ACT
      </text>
      <text x={81} y={902} fontSize={19} fill="#00EE00" className="Radio" textAnchor="start">
        STBY
      </text>
      ...
      <text x={197} y={963} fontSize={19} fill="#00EE00" className="Radio" textAnchor="start">
        TEMPEST
      </text>

      <text x={138} y={963} fontSize={19} fill="#00EE00" className="Radio" textAnchor="start">
        {Ident_Code}
      </text>

      <text x={73} y={830} fontSize={34} fill="rgb(245, 255, 137)" className="Radio" textAnchor="start">
        {DispMode}
      </text>
      <text x={193} y={830} fontSize={34} fill="rgb(245, 255, 137)" className="Radio" textAnchor="start">
        {SecureComms}
      </text>
      <text
      ...
      >
        {WACAP_Test ? '888.888' : DispActiveFreq}
      </text>
      <text
        ...
        textAnchor={Active_COM === 9 ? 'end' : 'start'}
      >
        {WACAP_Test ? '888.888' : DispStbyFreq}
      </text>
      ...
      <g visibility={Active_COM === 9 ? 'visible' : 'hidden'}>
        <text x={89} y={1016} fontSize={18} fill="#00EE00" className="Radio" textAnchor="Middle">
          REC
        </text>
        <text x={142} y={1016} fontSize={18} fill="#00EE00" className="Radio" textAnchor="Middle">
          T/R
        </text>
        <text x={196} y={1016} fontSize={18} fill="#00EE00" className="Radio" textAnchor="Middle">
          A/REC
        </text>
        <text x={250} y={1016} fontSize={18} fill="#00EE00" className="Radio" textAnchor="Middle">
          AT/R
        </text>
      </g>
    </g>
