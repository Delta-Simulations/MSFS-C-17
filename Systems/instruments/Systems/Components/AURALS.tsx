...
export const AURALS = () => {
  ...
  return (
    <g>
      <text x={0} y={50} fontSize={100} fill="white">
        {ATEngaged}
      </text>

      <text x={50} y={50} fontSize={100} fill="white">
        {ThrrotleWarning && ATEngaged && WacsFail && Cargo_door_Sound && StabMotion && ThrrotleWarning && ATEngaged}
      </text>
    </g>
  )
}
