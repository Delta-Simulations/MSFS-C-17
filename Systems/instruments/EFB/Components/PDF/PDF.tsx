      ...
      <ThemeProvider theme={ButtonColour}>
        ...
        >
          <Stack direction="row" spacing={1}>
            <Button size="small" variant="contained" onClick={handlePreviousPage}>
              &lt;
            </Button>
            <h2 style={{ color: '#aeb0b3' }}>
              Page {currentPage} and {currentPage + 1} of {totalPages}
            </h2>
            <Button size="small" variant="contained" onClick={handleInvert}>
              Invert Colors
            </Button>
            <Button size="small" variant="contained" onClick={() => setFMMode(!FMMode)}>
            ...
            <Button
              ...
              variant="contained"
              onClick={() =>
                bookmarks.includes(currentPage) ? bookmarkPageRemove(currentPage) : bookmarkPageAdd(currentPage)
              }
            >
